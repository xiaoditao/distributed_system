<%-- 
    Document   : result
    Created on : Feb 2, 2019, 8:22:54 PM
    Author     : xiaoditao
--%>
...
<html>
    ...
    <body>
            ...
            <h1>There is no picture to list.</h1>
            <% } else { %>
            <p> The website URL is: </p>
            <p> <%=request.getAttribute("zongURL")%> </p>
            <img src="<%= request.getAttribute("pictureURL")%>" width="460px"><br><br>
            <% } %>
